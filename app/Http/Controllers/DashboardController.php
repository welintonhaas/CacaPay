...
class dashboardController extends Controller{
	...
	function index(){
		...
		if (Auth::user()->Admin()) {
			...
			// Obtem os clientes	
			$clientes = Cliente::selectRaw('created_at as data, count(*) as quant')->groupByRaw('DAY(created_at)')->get();
			...
			// Obtem Transações
			$transacao = Transacoes::selectRaw('data, count(data) as quant')->groupByRaw('DAY(data)')->get();
